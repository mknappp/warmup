...
This project is to ease back into coding after winter break. The outcome is going to be code that checks some matrix of intiger values that are given to form a magic square. The goal will also be able to generate its own magic square. 
